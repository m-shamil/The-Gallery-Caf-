...
// Fetch Chinese cuisines from the database
$sql = "SELECT id_chinese, name, description, price, image FROM chinese_cuisines";
            ...
            <div id="menu-items">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<input type='number' name='items[" . htmlspecialchars($row["id_chinese"]) . "][quantity]' class='quantity' min='0' value='0'>";
                        echo "<input type='hidden' name='items[" . htmlspecialchars($row["id_chinese"]) . "][id]' value='" . htmlspecialchars($row["id_chinese"]) . "'>";
                        echo "<input type='hidden' name='items[" . htmlspecialchars($row["id_chinese"]) . "][name]' value='" . htmlspecialchars($row["name"]) . "'>";
                        echo "<input type='hidden' name='items[" . htmlspecialchars($row["id_chinese"]) . "][price]' value='" . htmlspecialchars($row["price"]) . "'>";
                        echo "<input type='hidden' name='items[" . htmlspecialchars($row["id_chinese"]) . "][description]' value='" . htmlspecialchars($row["description"]) . "'>";
                        echo "</div>";
                        echo "</div>";
                    }
                } else {
