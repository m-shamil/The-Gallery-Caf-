...
// Fetch Italian cuisines from the database
$sql = "SELECT id_italy, name, description, price, image FROM italy_cuisines";
            ...
            <div id="menu-items">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<input type='number' name='items[" . htmlspecialchars($row["id_italy"]) . "][quantity]' class='quantity' min='0' value='0'>";
                        echo "<input type='hidden' name='items[" . htmlspecialchars($row["id_italy"]) . "][id]' value='" . htmlspecialchars($row["id_italy"]) . "'>";
                        echo "<input type='hidden' name='items[" . htmlspecialchars($row["id_italy"]) . "][name]' value='" . htmlspecialchars($row["name"]) . "'>";
                        echo "<input type='hidden' name='items[" . htmlspecialchars($row["id_italy"]) . "][price]' value='" . htmlspecialchars($row["price"]) . "'>";
                        echo "<input type='hidden' name='items[" . htmlspecialchars($row["id_italy"]) . "][description]' value='" . htmlspecialchars($row["description"]) . "'>";
                        echo "</div>";
                        echo "</div>";
                    }
                } else {
